...
#         return render(request, 'consumer/submit_request.html', {'form': form})
#     @login_required
...
#             return redirect('consumer:track_requests')
#         return render(request, 'consumer/submit_request.html', {'form': form})
...
#         return render(request, 'consumer/track_requests.html', {'service_requests': service_requests})
...
class AccountInfoView(View):
    def get(self, request):
        customer = Customer.objects.get(user=request.user)  # Assuming user is authenticated
        return render(request, 'consumer/account_info.html', {'customer': customer})
